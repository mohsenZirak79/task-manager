...
class UserResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'role_id' => $this->whenLoaded('role', fn () => $this->role?->id),
            'role_title' => $this->whenLoaded('role', fn () => $this->role?->title),
            'visible_tabs' => $this->whenLoaded('role', fn () => $this->role?->visible_tabs ?? []),
